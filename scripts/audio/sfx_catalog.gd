...
const MIXER_GROUPS := [
	{
		...
		"subtitle": "Elemental",
		"clips": [
			{"id": "fire.cast", "label": "Firebolt / Meteor windup"},
			{"id": "firebolt.travel", "label": "Firebolt in flight"},
			{"id": "firebolt.explode", "label": "Firebolt impact"},
			{"id": "freeze.blast", "label": "Freeze cone"},
			{"id": "freeze.lock", "label": "Freeze lock"},
			{"id": "thunder_wave.cast", "label": "Thunder Wave cast"},
			{"id": "thunder_wave.hop", "label": "Thunder Wave hit"},
			{"id": "meteor.impact", "label": "Meteor fall + explosion"},
			{"id": "chilled_ground.place", "label": "Chilled Ground place"},
